...
class EasySetup {
	 ...
	 * @return void
	 */
	public function fillSettingsTable($options = []) {
		$query = "
		...
		$data = [
			...
			['key' => 'data_directory',				'value' => $options['data_directory'], 'category' => 'settings',	'description' => 'Where recording data should be stored.'],
			...
			['key' => 'chunk_time',					'value' => '10',				'category' => 'record',		'description' => 'How many seconds between data being sent from client to server.'],
